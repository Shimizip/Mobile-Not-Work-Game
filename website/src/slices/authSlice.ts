...
export const login = createAsyncThunk(
  ...
  async (data: User, { rejectWithValue }) => {
    try {
      ...
      //const hashedPassword = "not implemented"
      ...
      params.append("passwort", data.passwort);
      console.log("Formatted data:", params.toString());
...
export const getSpieler = createAsyncThunk(
  "spieler",
  async (userId: string, { rejectWithValue }) => {
    try {
      console.log("getSpieler wird ausgefuehrt fuer:", userId)
      const response = await axiosInstance.get(`/spieler`);
      console.log("getSpieler response:", response)
      console.log("getSpieler response.data:", response.data)
      return response.data;
    } catch (error) {
      if (error instanceof AxiosError && error.response) {
        const errorResponse = error.response.data;
